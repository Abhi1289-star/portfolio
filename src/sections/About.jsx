      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1 relative">
          <img
            ...
            className="absolute scale-[1.75] -right-[5rem] -top-[1rem] md:scale-[3] md:left-[50] md:inset-y-10 lh:scale-[2.5]"
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Sanskar Pachauri.</p>
            <p className="subtext">
              Over the last four years, I developed my frontend and backend dev
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            ...
            <Card style={{ rotate: "90deg", bottom: "30%", left: "20%" }} text="Design Patterns" containerRef={grid2Container} />
        ...
        <div className="grid-black-color grid-3 relative">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in Ghaziabad, and open to remote work worldwide.
            </p>
          </div>
        ...
        <div className="grid-special-color grid-4">
          <div className="flex flex-col items-center justify-center gap-4 w-full h-full">
            <p className="text-center headtext">Do you want to collaborate?</p>
            <CopyEmailButton />
          </div>
        </div>
